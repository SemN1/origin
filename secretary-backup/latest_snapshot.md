# Origin Snapshot — 2026-03-13_13-28
...
## Progetti Attivi
- **Beauty Salon DB** (beauty-salon-db): active — Fase 1 - Completamento Database
- **CRM Personale** (crm-personale): planning — Definizione requisiti
- **Ollama Lab** (ollama-lab): planning — Setup iniziale
- **Personal RAG** (personal-rag): planning — Definizione architettura
